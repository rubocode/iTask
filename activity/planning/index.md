...
You can juggle the sequencing — priorities — at a high level and visualize them from the mountain top.

I use the **Catban** app for this purpose.  It is markdown based and is quite simple to use.  **Trello** can work for you too.  It is a bit heavier for the task, but it still cuts the mustard — and it is free.
